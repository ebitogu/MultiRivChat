...
import com.android.rivchat.ui.SplashActivity;
...
//            if (data.getStringExtra(STR_EXTRA_ACTION).equals(SplashActivity.STR_EXTRA_ACTION_LOGIN)) {
...
//            }else if(data.getStringExtra(STR_EXTRA_ACTION).equals(SplashActivity.STR_EXTRA_ACTION_RESET)){
